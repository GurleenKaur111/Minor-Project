...
def menu(r,i,n):
	...
	c1 = ImageTk.PhotoImage(Image.open('Logos.png'))
	...
	Button(frame1,text="SUGGESTIONS",font=("times new roman",16,"bold"),fg="#E8F0F2",bg="red",command=lambda:Suggestions.suggestions(window)).place(x=30,y=300,width=220,height=35)
	...
	Label(frame2,text="Recommendations",font=("times new roman",25,"bold"),fg="#053742",bg="#A2DBFA").place(x=230,y=35)
	...
	Label(frame3,text="Start Exercising",font=("times new roman",20,"bold"),fg="#053742",bg="#A2DBFA").place(x=40,y=15)

	Label(frame3,text="1. Curls",font=("times new roman",18,"bold"),fg="#053742",bg="#A2DBFA").place(x=20,y=65)
	Button(frame3,text="Tutorial",font=("times new roman",14,"bold"),fg="#053742",bg="#E8F0F2", command=lambda:callback("https://www.youtube.com/watch?v=av7-8igSXTs&list=PL6cJnPFy3bBn5Aiup3qm68q35FI12nVd_&index=1")).place(x=30,y=105,width=110,height=20)
	Button(frame3,text="Start",font=("times new roman",14,"bold"),fg="#053742",bg="#E8F0F2",command=lambda:Curls.Curls()).place(x=145,y=105,width=110,height=20)

	Label(frame3,text="2. Dumbbell Press",font=("times new roman",18,"bold"),fg="#053742",bg="#A2DBFA").place(x=20,y=165)
	Button(frame3,text="Tutorial",font=("times new roman",14,"bold"),fg="#053742",bg="#E8F0F2", command=lambda:callback("https://www.youtube.com/watch?v=B-aVuyhvLHU&list=PL6cJnPFy3bBn5Aiup3qm68q35FI12nVd_&index=2")).place(x=30,y=205,width=110,height=20)
	Button(frame3,text="Start",font=("times new roman",14,"bold"),fg="#053742",bg="#E8F0F2",command=lambda:DumbellPress.DumbellPress()).place(x=145,y=205,width=110,height=20)

	Label(frame3,text="3. Lateral Raise",font=("times new roman",18,"bold"),fg="#053742",bg="#A2DBFA").place(x=20,y=265)
	Button(frame3,text="Tutorial",font=("times new roman",14,"bold"),fg="#053742",bg="#E8F0F2", command=lambda:callback("https://www.youtube.com/watch?v=kDqklk1ZESo&list=PL6cJnPFy3bBn5Aiup3qm68q35FI12nVd_&index=3")).place(x=30,y=305,width=110,height=20)
	Button(frame3,text="Start",font=("times new roman",14,"bold"),fg="#053742",bg="#E8F0F2",command=lambda:LateralRaise.LateralRaise()).place(x=145,y=305,width=110,height=20)

	Label(frame3,text="4. Squats",font=("times new roman",18,"bold"),fg="#053742",bg="#A2DBFA").place(x=20,y=365)
	Button(frame3,text="Tutorial",font=("times new roman",14,"bold"),fg="#053742",bg="#E8F0F2", command=lambda:callback("https://www.youtube.com/watch?v=6AEDbzzFGsM&list=PL6cJnPFy3bBn5Aiup3qm68q35FI12nVd_&index=4")).place(x=30,y=405,width=110,height=20)
	Button(frame3,text="Start",font=("times new roman",14,"bold"),fg="#053742",bg="#E8F0F2",command=lambda:Squats.Squats()).place(x=145,y=405,width=110,height=20)

	Label(frame3,text="5. Triceps Extension",font=("times new roman",18,"bold"),fg="#053742",bg="#A2DBFA").place(x=20,y=465)
	Button(frame3,text="Tutorial",font=("times new roman",14,"bold"),fg="#053742",bg="#E8F0F2", command=lambda:callback("https://www.youtube.com/watch?v=nRiJVZDpdL0&list=PL6cJnPFy3bBn5Aiup3qm68q35FI12nVd_&index=5")).place(x=30,y=505,width=110,height=20)
	Button(frame3,text="Start",font=("times new roman",14,"bold"),fg="#053742",bg="#E8F0F2",command=lambda:TricepsExtension.TricepsExtension()).place(x=145,y=505,width=110,height=20)
